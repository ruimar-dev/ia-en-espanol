...
export const herramientas: Herramienta[] = [
  ...
  { slug: 'mistral-ai', nombre: 'Mistral AI', descripcion: 'Laboratorio de IA francés con modelos open-weight y foco en soberanía de datos. Le Chat es su interfaz de chat, Codestral su modelo de código.', categoria: 'generacion-texto', rating: 4.0, logo: '/images/logos/mistral.svg', url: 'https://mistral.ai' },
  ...
  { slug: 'adobe-firefly', nombre: 'Adobe Firefly', descripcion: 'IA de imágenes de Adobe entrenada con contenido con licencia e indemnización legal para uso comercial. Integración directa en Photoshop e Illustrator; imágenes estándar ilimitadas en planes de pago.', categoria: 'generacion-imagen', rating: 4.2, logo: '/images/logos/adobe-firefly.svg', url: 'https://firefly.adobe.com' },
  { slug: 'flux', nombre: 'Flux', descripcion: 'Familia de modelos de imagen de Black Forest Labs (FLUX.2). Calidad comparable a Midjourney, con versión open source ejecutable localmente sin coste.', categoria: 'generacion-imagen', rating: 4.6, logo: '/images/logos/flux.svg', url: 'https://bfl.ai' },
  { slug: 'nano-banana-2', nombre: 'Nano Banana 2', descripcion: 'Generador y editor de imágenes de Google (Gemini 3.1 Flash Image). Referente en edición conversacional y consistencia de personajes; su versión Lite prioriza velocidad y coste.', categoria: 'generacion-imagen', rating: 4.5, logo: '/images/logos/nano-banana.svg', url: 'https://gemini.google.com' },
  ...
  { slug: 'windsurf', nombre: 'Windsurf', descripcion: 'IDE con IA nacido de Codeium, hoy propiedad de Cognition y renombrado "Devin Desktop" (jun-2026). Cascade sigue disponible como uno de varios agentes seleccionables.', categoria: 'codigo', rating: 4.6, logo: '/images/logos/windsurf.svg', url: 'https://devin.ai/desktop' },
  { slug: 'claude-code', nombre: 'Claude Code', descripcion: 'Agente de programación de Anthropic para la terminal. Navega repositorios enteros, ejecuta comandos y corrige errores de forma autónoma.', categoria: 'codigo', rating: 4.3, logo: '/images/logos/claude.svg', url: 'https://claude.com/product/claude-code' },
  ...
  { slug: 'codeium', nombre: 'Codeium', descripcion: 'Ya no existe como producto independiente: se rebrandeó a Windsurf en 2025 y hoy forma parte de Devin Desktop (Cognition). codeium.com redirige a la web de Devin Desktop.', categoria: 'codigo', rating: 4.2, logo: '/images/logos/codeium.svg' },
  // Audio
  ...
  { slug: 'suno', nombre: 'Suno', descripcion: 'Genera canciones completas (letra, voz, instrumentación) a partir de un prompt de texto. Licencia de uso comercial en los planes de pago.', categoria: 'audio', rating: 4.5, logo: '/images/logos/suno.svg', url: 'https://suno.com' },
  { slug: 'udio', nombre: 'Udio', descripcion: 'Generador de música con IA relanzado como plataforma cerrada con catálogo licenciado de Universal: se escucha y comparte dentro de la app, sin descargas.', categoria: 'audio', rating: 3.8, logo: '/images/logos/udio.svg', url: 'https://udio.com' },
  // Vídeo
  { slug: 'google-veo-3', nombre: 'Google Veo 3', descripcion: 'Generador de vídeo de Google DeepMind con audio nativo: diálogos con sincronización labial, efectos de sonido y música en la misma generación. Integrado en Gemini y Flow.', categoria: 'video', rating: 4.6, logo: '/images/logos/veo.svg', url: 'https://deepmind.google/models/veo/' },
  ...
  { slug: 'sora', nombre: 'Sora', descripcion: 'Generador de vídeo de OpenAI, retirado como app de consumo en abril de 2026. Su API para desarrolladores sigue operativa hasta septiembre de 2026.', categoria: 'video', rating: 4.3, logo: '/images/logos/sora.svg' },
  ...
  { slug: 'luma-dream-machine', nombre: 'Luma Dream Machine', descripcion: 'Generador de vídeo de Luma AI especializado en movimiento de cámara cinematográfico. Rebrandeado en 2026 como "Luma" (modelo Ray 3.2), sin plan gratuito continuado.', categoria: 'video', rating: 4.2, logo: '/images/logos/luma.svg', url: 'https://lumalabs.ai' },
  // Productividad
