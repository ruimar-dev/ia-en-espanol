...
herramientas: ["ChatGPT", "Claude", "Gemini", "Perplexity AI"]
...
<TablaComparativa
  ...
  herramientas={[
    { nombre: "ChatGPT (Plus)", precio: "20 $/mes (~23€ con IVA)", puntuacion: 4.6, idealPara: "Simulacros conversacionales largos y preguntas técnicas" },
    { nombre: "Claude Fable 5", precio: "20€/mes (Claude Pro)", puntuacion: 4.7, idealPara: "Feedback estructurado y directo sobre tus respuestas" },
    { nombre: "Gemini (Google AI Pro)", precio: "Gratis / 21,99€/mes", puntuacion: 4.3, idealPara: "Integración con Google Docs para pulir respuestas escritas" },
...
Depende del uso. ChatGPT funciona muy bien para simulacros largos y conversacionales, especialmente con GPT-5.6 Thinking para preguntas técnicas complejas. Claude Fable 5 tiende a dar feedback más directo y estructurado sobre tus respuestas, lo que a mí me resultó más útil en la fase de pulido final.
