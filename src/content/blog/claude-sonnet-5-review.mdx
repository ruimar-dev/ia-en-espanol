...
herramientas: ["Claude Sonnet 5", "Claude Code", "Cursor", "Windsurf", "OpenClaw", "DeepSeek R1"]
...
faqs:
  ...
  - pregunta: "¿Cuánto cuesta usar Claude Sonnet 5?"
    respuesta: "Está incluido en el plan Claude Pro (20€/mes, o aprox. 18€/mes con facturación anual). Por API cuesta 3$/15$ por millón de tokens de entrada/salida, con precio de lanzamiento de 2$/10$ hasta el 31 de agosto de 2026 — frente a los 5$/25$ de Opus 4.8."
  ...
  - pregunta: "¿Es mejor Claude Sonnet 5 o GPT-5.5 para programar?"
    respuesta: "En mis pruebas ambos rinden de forma muy similar en tareas de programación cotidianas. Sonnet 5 suele ser algo más consistente en proyectos con Claude Code o Cursor, mientras que GPT-5.5 tiene ventaja en tareas multimodales que combinan texto e imagen."
...
<TablaComparativa
  ...
  herramientas={[
    { nombre: "Claude Sonnet 5", precio: "20€/mes (Pro) o 2$/10$ por millón de tokens (API)", puntuacion: 4.6, idealPara: "Agentes de IA y automatización a gran escala" },
    { nombre: "ChatGPT (GPT-5.5)", precio: "Incluido en ChatGPT Plus (~20$/mes)", puntuacion: 4.4, idealPara: "Uso general y multimodal" },
    { nombre: "Google AI Pro", precio: "Desde 21,99€/mes", puntuacion: 4.3, idealPara: "Integración con Google Workspace" },
...
Está incluido en el plan Claude Pro (20€/mes, o aprox. 18€/mes con facturación anual). Por API cuesta 3$/15$ por millón de tokens de entrada/salida, con precio de lanzamiento de 2$/10$ hasta el 31 de agosto de 2026 — frente a los 5$/25$ de Opus 4.8.
...
**¿Es mejor Claude Sonnet 5 o GPT-5.5 para programar?**
En mis pruebas ambos rinden de forma muy similar en tareas de programación cotidianas. Sonnet 5 suele ser algo más consistente en proyectos con Claude Code o Cursor, mientras que GPT-5.5 tiene ventaja en tareas multimodales que combinan texto e imagen.
