...
faqs:
  - pregunta: "¿Qué IA es la más usada en empresas españolas en 2026?"
    respuesta: "No hay un dato oficial centralizado, pero por lo que se observa en el sector, ChatGPT y Claude son las más adoptadas en despachos, consultoras y pymes tecnológicas, mientras que Gemini gana terreno en empresas que ya usan Google Workspace de forma intensiva."
...
<TablaComparativa
  ...
  herramientas={[
    { nombre: "ChatGPT", precio: "Gratis / Plus 20$/mes (~23€ IVA)", puntuacion: 4.6, idealPara: "Uso general, redacción y brainstorming" },
    { nombre: "Claude", precio: "Gratis / Pro 20€/mes", puntuacion: 4.7, idealPara: "Documentos largos, análisis legal y contratos" },
    { nombre: "Gemini 3.1 Pro", precio: "Gratis / Google AI Pro 21,99€/mes", puntuacion: 4.4, idealPara: "Integración con Workspace y Google Drive" },
    { nombre: "Mistral AI (Le Chat)", precio: "Gratis / Pro 14,99$/mes", puntuacion: 4.2, idealPara: "Empresas que priorizan datos alojados en la UE" },
  ]}
/>
...
No hay un dato oficial centralizado, pero por lo que se observa en el sector, ChatGPT y Claude son las más adoptadas en despachos, consultoras y pymes tecnológicas, mientras que Gemini gana terreno en empresas que ya usan Google Workspace de forma intensiva.
