...
herramientas: ["ChatGPT", "Claude Fable 5"]
...
En mi caso, como freelance que escribe para clientes de marketing y tecnología, puedo decirte con datos concretos qué ha cambiado: hace tres años, redactar un artículo de 1.500 palabras me llevaba entre 3 y 4 horas contando investigación. Hoy, usando Claude Fable 5 para estructurar y ChatGPT para generar variaciones de titulares, ese mismo artículo me lleva entre 90 minutos y 2 horas, porque la parte mecánica —investigar datos básicos, generar esquemas, redactar transiciones— la delega la máquina. Lo que no ha cambiado es el tiempo que dedico a verificar hechos, aportar experiencia propia y darle un ángulo que no suene genérico. Esa parte sigue siendo 100% humana y, de hecho, cada vez vale más porque es lo que diferencia un texto de otro.
...
<TablaComparativa
  ...
  herramientas={[
    { nombre: "ChatGPT", precio: "Gratis / 20€ mes Plus", puntuacion: 4.6, idealPara: "Redacción, atención al cliente, tareas administrativas" },
    { nombre: "Claude Fable 5", precio: "Gratis / desde 20€ mes", puntuacion: 4.7, idealPara: "Análisis largo, documentos legales y técnicos" },
    { nombre: "GitHub Copilot", precio: "Desde 10€ mes", puntuacion: 4.5, idealPara: "Programación junior y tareas repetitivas de código" },
    { nombre: "Cursor", precio: "Gratis / desde 20€ mes", puntuacion: 4.6, idealPara: "Desarrollo de software con IA integrada en el editor" },
  ]}
/>

Los precios de estas herramientas cambian con cierta frecuencia, así que te recomiendo verificarlos en la web oficial de cada una antes de suscribirte a nada.
...
- **Consultor de adopción de IA para pymes**: ayudo yo mismo a algún cliente pequeño a decidir qué herramienta usar (¿ChatGPT o Claude? ¿Cursor o Windsurf?) y cómo integrarla sin romper procesos existentes. Es un trabajo de consultoría que antes no tenía sentido económico.
...
**Trabajos de liderazgo, negociación y gestión de conflictos humanos** son otro terreno donde probé, sin éxito real, delegar en IA la preparación de una negociación salarial delicada con un cliente. El modelo me dio argumentos razonables, pero cuando llegó el momento de leer el tono de la otra persona, ajustar sobre la marcha y tomar decisiones con matices políticos internos de la empresa, ninguna herramienta me sustituyó. Eso lo sigo haciendo yo, con la experiencia acumulada de años, no con un prompt.

Y luego está el error más común que veo en managers que se lanzan a automatizar sin criterio: confundir "la IA genera un output que parece correcto" con "la IA entiende lo que está haciendo". He visto casos de empresas que despidieron a redactores junior confiando en que ChatGPT cubriría el hueco, y seis meses después tuvieron que recontratar porque nadie revisaba la coherencia de marca ni corregía errores factuales sutiles que el modelo colaba con total confianza. Si quieres profundizar en este tipo de errores de implementación, tengo un análisis sobre [si la IA va a quitarte el trabajo realmente](/blog/ia-quitara-trabajo-2026) donde desgloso casos similares con más detalle.
